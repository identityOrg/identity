...
public class StandardClaim {
     ...
     * present, with the names being separated by space characters. Also note that in some cultures,
     * middle names are not used.
     */
    @Column(name = "MIDDLE_NAME")
    private String middle_name;
    /**
     * Casual name of the End-User that may or may not be the same as the given_name. For instance, a nickname
     ...
     * End-User at the time the verification was performed. The means by which an e-mail address is verified
     ...
     */
    @Column(name = "NAME_VERIFIED")
    private Boolean email_verified;
    /**
     * End-User's gender. Values defined by this specification are female and male. Other values MAY
     ...
     * The year MAY be 0000, indicating that it is omitted. To represent only the year, YYYY format
     * is allowed. Note that depending on the underlying platform's date related function, providing
     * just year can result in varying month and day, so the implementers need to take this
     ...
     * country code in uppercase, separated by a dash. For example, en-US or fr-CA. As a compatibility note,
     * some implementations have used an underscore as the separator rather than a dash, for example, en_US;
     ...
     * are operating. When true, the phone_number Claim MUST be in E.164 format and any extensions
