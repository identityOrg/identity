...
public class OAuthController {
	...
	public OAuthToken passwordGrantToken(@RequestParam(value = "username") String username,
			...
			@RequestParam(value = "scope", defaultValue = "") String scope, Authentication clientAuth) {
	...
	public OAuthToken authorizationCodeGrantToken(@RequestParam(value = "code", required = false) String code,
			...
			@RequestParam(value = "client_id", required = false) String clientId, Authentication authentication) {
		log.info("Processing password grant");
		Client client = null;
	...
	public String oAuthAuthorize(@RequestParam(value = "response_type", required = false) String responseType,
			...
			@RequestParam(value = "state", required = false) String state, Authentication authentication, Model model) {
